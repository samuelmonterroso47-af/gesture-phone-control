...
val GESTURE_LESSONS = listOf(
    GestureLesson(
        ...
        instruction = "$INDEX_ONLY hacia arriba. Sostén la pose — mientras la mantengas, sigue deslizando."
    ),
    GestureLesson(
    ...
    GestureLesson(
        pose = HandPoseState.OpenPalm,
        title = "Atrás",
        instruction = "Abre la mano por completo, con los 4 dedos extendidos. Sostén la pose."
    ),
    GestureLesson(
